...
static const yytype_int16 yyrline[] =
{
     ...
     292,   325,   328,   352,   356,   361,   372,   378,   383,   395,
     401,   420,   425,   440,   452,   464,   476,   488,   500,   512,
     524,   537,   557,   562,   567,   572,   577,   596,   619,   626,
     629,   636,   639,   652,   665,   678,   691,   704,   718,   724,
     731,   740,   750,   761
};
#endif
...
#line 1769 "alfa.tab.c"
    break;

  case 35:
#line 281 "alfa.y"
                              {fprintf(yyout,";R35:\t<sentencia_simple> ::= <lectura>\n");}
#line 1775 "alfa.tab.c"
    break;

  case 36:
#line 283 "alfa.y"
                              {fprintf(yyout,";R36:\t<sentencia_simple> ::= <escritura>\n");}
#line 1781 "alfa.tab.c"
    break;

  case 37:
#line 285 "alfa.y"
                              {fprintf(yyout,";R38:\t<sentencia_simple> ::= <retorno_funcion>\n");}
#line 1787 "alfa.tab.c"
    break;

  case 38:
#line 288 "alfa.y"
                              {fprintf(yyout,";R40:\t<bloque> ::= <condicional>\n");}
#line 1793 "alfa.tab.c"
    break;

  case 39:
#line 290 "alfa.y"
                              {fprintf(yyout,";R41:\t<bloque> ::= <bucle>\n");}
#line 1799 "alfa.tab.c"
    break;
...
#line 2236 "alfa.tab.c"
    break;

  case 69:
#line 627 "alfa.y"
                              {fprintf(yyout,";R90:\t<lista_expresiones> ::= \n");}
#line 2242 "alfa.tab.c"
    break;
...
#line 2253 "alfa.tab.c"
    break;

  case 71:
#line 637 "alfa.y"
                              {fprintf(yyout,";R92:\t<resto_lista_expresiones> ::= \n");}
#line 2259 "alfa.tab.c"
    break;
